...
const AssetItem = ({assetItem}) => {
    const { assetName, price, priceVariation } = assetItem ;
    return(
        <div className="asset-item">
           <a href="/quote/DIA" className="dist_tick column">
               <div className="my-3 mx-5 has-text-light is-size-6">
                    ...
                    <div className="mt-1 has-text-success">
                        <span className="icon is-left dist_icon__35B3C">
                            <i className="" data-fa-i2svg="" data-prefix="fas" data-icon="caret-up"><svg className="svg-inline--fa fa-caret-up fa-w-10" data-fa-i2svg="" data-prefix="fas" data-icon="caret-up" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
